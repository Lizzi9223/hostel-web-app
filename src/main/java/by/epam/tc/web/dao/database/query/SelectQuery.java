...
public interface SelectQuery {
    ...
    String getSelectQueryDoubleWhere(String tableName, 
    ...
    String getInnerJoinSelectQueryWhere(String mainTableName, String joinTableName, String joinFieldName,String whereClauseColumn);
    ...
    String getInnerJoinSelectQueryDoubleWhere(String mainTableName, String joinTableName, 
    		String joinFieldName,String whereClauseColumn1,String whereClauseColumn2);
}
