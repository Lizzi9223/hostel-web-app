...
<fmt:message bundle="${lang}" key="logination.password"
	var="password_word" />
<fmt:message bundle="${lang}" key="logination.back" var="back" />

<fmt:message bundle="${lang}" key="registration.registration"
	var="registration" />
<fmt:message bundle="${lang}" key="registration.name" var="name_word" />
<fmt:message bundle="${lang}" key="registration.photo" var="photo_word" />
<fmt:message bundle="${lang}" key="registration.surname"
	var="surname_word" />
<fmt:message bundle="${lang}" key="registration.passport_id"
	var="passport_id_word" />
<fmt:message bundle="${lang}" key="registration.date_of_birth"
	var="date_of_birth_word" />
<fmt:message bundle="${lang}" key="registration.country"
	var="country_word" />
<fmt:message bundle="${lang}" key="registration.phone_number"
	var="phone_number_word" />
...
<fmt:message bundle="${lang}" key="stays.departure_date"
	var="departure_date" />
<fmt:message bundle="${lang}" key="stays.check" var="check" />
<fmt:message bundle="${lang}" key="stays.arrive_date" var="arrive_date" />
<fmt:message bundle="${lang}" key="stays.number_of_guests"
	var="number_of_guests" />
<fmt:message bundle="${lang}" key="stays.check_among_all_rooms"
	var="check_among_all_rooms" />
<fmt:message bundle="${lang}" key="stays.submit_stay" var="submit_stay" />
<fmt:message bundle="${lang}" key="stays.please_check_data"
	var="please_check_data" />
...
<fmt:message bundle="${lang}" key="rooms.private_bathroom"
	var="private_bathroom" />
<fmt:message bundle="${lang}" key="rooms.yes" var="yes" />
<fmt:message bundle="${lang}" key="rooms.photos_of_common_areas"
	var="photos_of_common_areas" />
<fmt:message bundle="${lang}" key="rooms.booking" var="booking_word" />
<fmt:message bundle="${lang}" key="rooms.sign_in_first"
	var="sign_in_first" />
<fmt:message bundle="${lang}" key="rooms.private_bathroom_in_room"
	var="private_bathroom_in_room" />

<fmt:message bundle="${lang}" key="account.my_account" var="my_account" />
<fmt:message bundle="${lang}" key="account.clients_word"
	var="clients_word" />
<fmt:message bundle="${lang}" key="account.bookings_word"
	var="bookings_word" />
<fmt:message bundle="${lang}" key="account.stays_word" var="stays_word" />
<fmt:message bundle="${lang}" key="account.change_password"
	var="change_password" />
<fmt:message bundle="${lang}" key="account.delete_account"
	var="delete_account" />
<fmt:message bundle="${lang}" key="account.create_new_admin"
	var="create_new_admin" />
<fmt:message bundle="${lang}" key="account.current_password"
	var="current_password" />
<fmt:message bundle="${lang}" key="account.new_password"
	var="new_password" />
<fmt:message bundle="${lang}" key="account.repeat_new_password"
...
<fmt:message bundle="${lang}" key="clients.client_already_added"
	var="client_already_added" />
<fmt:message bundle="${lang}" key="clients.all_clients"
	var="all_clients_word" />
<fmt:message bundle="${lang}" key="clients.clients_left_word"
	var="clients_left_word" />
<fmt:message bundle="${lang}" key="clients.finish_word"
	var="finish_word" />
<fmt:message bundle="${lang}" key="clients.new_client_word"
	var="new_client_word" />
<fmt:message bundle="${lang}" key="clients.search_by_word"
	var="search_by_word" />
...
<fmt:message bundle="${lang}" key="bookRoom.sorry_no_avail_places"
	var="sorry_no_avail_places" />
<fmt:message bundle="${lang}" key="bookRoom.submit_booking"
	var="submit_booking" />

<fmt:message bundle="${lang}" key="bookings.all_bookings_word"
	var="all_bookings_word" />
<fmt:message bundle="${lang}" key="bookings.my_bookings_word"
	var="my_bookings_word" />
<fmt:message bundle="${lang}" key="bookings.new_booking_word"
	var="new_booking_word" />
<fmt:message bundle="${lang}" key="bookings.user_id_word"
	var="user_id_word" />
<fmt:message bundle="${lang}" key="bookings.guests_word"
	var="guests_word" />
<fmt:message bundle="${lang}" key="bookings.is_approved_word"
	var="is_approved_word" />
<fmt:message bundle="${lang}" key="bookings.approve_date_word"
	var="approve_date_word" />
<fmt:message bundle="${lang}" key="bookings.price_word" var="price_word" />
<fmt:message bundle="${lang}" key="bookings.is_paid_word"
	var="is_paid_word" />
<fmt:message bundle="${lang}" key="bookings.approve_word"
	var="approve_word" />
<fmt:message bundle="${lang}" key="bookings.disapprove_word"
	var="disapprove_word" />
<fmt:message bundle="${lang}" key="bookings.guests_arrived_word"
	var="guests_arrived_word" />
<fmt:message bundle="${lang}" key="bookings.pay" var="pay" />
<fmt:message bundle="${lang}" key="bookings.current_room_word"
	var="current_room_word" />
<fmt:message bundle="${lang}" key="bookings.booking_was_rejected_msg"
	var="booking_was_rejected_msg" />
<fmt:message bundle="${lang}"
	key="bookings.booking_not_approved_yet_msg"
	var="booking_not_approved_yet_msg" />
<fmt:message bundle="${lang}"
